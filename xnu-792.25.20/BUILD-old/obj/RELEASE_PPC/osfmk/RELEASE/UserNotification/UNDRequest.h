...
extern
#endif	/* mig_external */
kern_return_t UNDDisplayCustomFromDictionary_rpc
(
	UNDServerRef server,
	mach_port_t reply,
	xmlData_t data,
...
#pragma pack(4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		mach_msg_type_number_t dataCnt;
	} __Request__UNDDisplayCustomFromDictionary_rpc_t;
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
union __RequestUnion__UNDRequest_subsystem {
	...
	__Request__UNDDisplayCustomFromDictionary_rpc_t Request_UNDDisplayCustomFromDictionary_rpc;
...
#pragma pack(4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		kern_return_t RetCode;
	} __Reply__UNDDisplayCustomFromDictionary_rpc_t;
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
union __ReplyUnion__UNDRequest_subsystem {
	...
	__Reply__UNDDisplayCustomFromDictionary_rpc_t Reply_UNDDisplayCustomFromDictionary_rpc;
...
#define subsystem_to_name_map_UNDRequest \
    ...
    { "UNDDisplayCustomFromDictionary_rpc", 6004 },\
