...
{
	__V_*		data;		/* user data, initially 0	*/
	int		flags;		/* flags			*/
...
extern __MANGLE__ int		coclose __PROTO__((Coshell_t*));
extern __MANGLE__ Cojob_t*		coexec __PROTO__((Coshell_t*, const char*, int, const char*, const char*, const char*));
extern __MANGLE__ char*		coinit __PROTO__((int));
extern __MANGLE__ int		coexport __PROTO__((Coshell_t*, const char*, const char*));
extern __MANGLE__ int		cokill __PROTO__((Coshell_t*, Cojob_t*, int));
extern __MANGLE__ Coshell_t*	coopen __PROTO__((const char*, int, const char*));
extern __MANGLE__ void		coquote __PROTO__((Sfio_t*, const char*, int));
extern __MANGLE__ int		cosync __PROTO__((Coshell_t*, const char*, int, int));
extern __MANGLE__ Cojob_t*		cowait __PROTO__((Coshell_t*, Cojob_t*, int));

extern __MANGLE__ int		cojobs __PROTO__((Coshell_t*));
extern __MANGLE__ int		copending __PROTO__((Coshell_t*));
extern __MANGLE__ int		cozombie __PROTO__((Coshell_t*));

extern __MANGLE__ int		coattr __PROTO__((Coshell_t*, const char*));

extern __MANGLE__ int		coprocrun __PROTO__((const char*, char**, int));
extern __MANGLE__ int		cosystem __PROTO__((const char*));
