...
# AT&T Research
#
# @(#)C probe (AT&T Research) 2010-08-20
#
...
tmpdir=$tmpdir/probe$$
undef="define defined elif else endif error if ifdef ifndef include line pragma undef __STDC__ __STDPP__ __ARGC__ __BASE__ __BASE_FILE__ __DATE__ __FILE__ __FUNCTION__ __INCLUDE_LEVEL__ __LINE__ __PATH__ __TIME__ __VERSION__"
version_flags=
version_stamp=
version_string=
...
# AT&T Research
#
# @(#)make.probe (AT&T Research) 2011-02-02
#
# C probe for make
#
