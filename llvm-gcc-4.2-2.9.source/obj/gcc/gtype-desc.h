...
#define gt_ggc_m_8eh_range(X) do { \
  if (X != NULL) gt_ggc_mx_eh_range (X);\
  } while (0)
extern void gt_ggc_mx_eh_range (void *);
#define gt_ggc_m_11parser_ctxt(X) do { \
  if (X != NULL) gt_ggc_mx_parser_ctxt (X);\
  } while (0)
extern void gt_ggc_mx_parser_ctxt (void *);
#define gt_ggc_m_10jdeplist_s(X) do { \
  if (X != NULL) gt_ggc_mx_jdeplist_s (X);\
  } while (0)
extern void gt_ggc_mx_jdeplist_s (void *);
#define gt_ggc_m_10java_lexer(X) do { \
  if (X != NULL) gt_ggc_mx_java_lexer (X);\
  } while (0)
extern void gt_ggc_mx_java_lexer (void *);
#define gt_ggc_m_12ZipDirectory(X) do { \
  if (X != NULL) gt_ggc_mx_ZipDirectory (X);\
  } while (0)
...
#define gt_ggc_m_13pointer_set_t(X) do { \
  if (X != NULL) gt_ggc_mx_pointer_set_t (X);\
  } while (0)
extern void gt_ggc_mx_pointer_set_t (void *);
...
#define gt_pch_n_8eh_range(X) do { \
  if (X != NULL) gt_pch_nx_eh_range (X);\
  } while (0)
extern void gt_pch_nx_eh_range (void *);
#define gt_pch_n_11parser_ctxt(X) do { \
  if (X != NULL) gt_pch_nx_parser_ctxt (X);\
  } while (0)
extern void gt_pch_nx_parser_ctxt (void *);
#define gt_pch_n_10jdeplist_s(X) do { \
  if (X != NULL) gt_pch_nx_jdeplist_s (X);\
  } while (0)
extern void gt_pch_nx_jdeplist_s (void *);
#define gt_pch_n_10java_lexer(X) do { \
  if (X != NULL) gt_pch_nx_java_lexer (X);\
  } while (0)
extern void gt_pch_nx_java_lexer (void *);
#define gt_pch_n_12ZipDirectory(X) do { \
  if (X != NULL) gt_pch_nx_ZipDirectory (X);\
  } while (0)
...
#define gt_pch_n_13pointer_set_t(X) do { \
  if (X != NULL) gt_pch_nx_pointer_set_t (X);\
  } while (0)
extern void gt_pch_nx_pointer_set_t (void *);
