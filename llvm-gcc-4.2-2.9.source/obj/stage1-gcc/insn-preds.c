...
#line 32 "../../gcc/config/rs6000/predicates.md"
...
#line 38 "../../gcc/config/rs6000/predicates.md"
(GET_CODE (op) != REG
...
{
  return ((GET_CODE (op) == REG) && (
#line 45 "../../gcc/config/rs6000/predicates.md"
...
#line 50 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 55 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 61 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 66 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 71 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 76 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 82 "../../gcc/config/rs6000/predicates.md"
...
{
  return (register_operand (op, mode)) && (
#line 87 "../../gcc/config/rs6000/predicates.md"
((GET_CODE (op) != REG
...
{
  return (register_operand (op, mode)) && (
#line 97 "../../gcc/config/rs6000/predicates.md"
(GET_CODE (op) != REG
		     || REGNO (op) > LAST_VIRTUAL_REGISTER
		     || CR_REGNO_P (REGNO (op))));
}
...
{
  return (register_operand (op, mode)) && (
#line 104 "../../gcc/config/rs6000/predicates.md"
(GET_CODE (op) != REG
		     || REGNO (op) > LAST_VIRTUAL_REGISTER
...
{
  return (GET_CODE (op) == CONST_INT) ? (
#line 122 "../../gcc/config/rs6000/predicates.md"
...
#line 131 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) ? (
#line 151 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) ? (
#line 161 "../../gcc/config/rs6000/predicates.md"
((HOST_BITS_PER_WIDE_INT == 32
		  && (mode == SImode || - INTVAL (op) < 0x7fff8000))
...
{
  return (GET_CODE (op) == CONST_INT) ? (
#line 173 "../../gcc/config/rs6000/predicates.md"
((GET_MODE_BITSIZE (mode) > HOST_BITS_PER_WIDE_INT
		  && INTVAL (op) >= 0)
		 || ((INTVAL (op) & GET_MODE_MASK (mode)
		      & (~ (unsigned HOST_WIDE_INT) 0xffffffff)) == 0))) : ((GET_CODE (op) == CONST_DOUBLE) ? (
#line 178 "../../gcc/config/rs6000/predicates.md"
(GET_MODE_BITSIZE (mode) > HOST_BITS_PER_WIDE_INT
		   && mode == DImode
...
#line 187 "../../gcc/config/rs6000/predicates.md"
{
  long k[4];
  REAL_VALUE_TYPE rv;
...
#line 278 "../../gcc/config/rs6000/predicates.md"
{
...
#line 320 "../../gcc/config/rs6000/predicates.md"
{
...
{
  return (((GET_CODE (op) == CONST_VECTOR) && ((
#line 318 "../../gcc/config/rs6000/predicates.md"
(TARGET_ALTIVEC)) && (
#line 319 "../../gcc/config/rs6000/predicates.md"
...
zero_constant (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 329 "../../gcc/config/rs6000/predicates.md"
(op == CONST0_RTX (mode));
}
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 335 "../../gcc/config/rs6000/predicates.md"
...
#line 344 "../../gcc/config/rs6000/predicates.md"
(MEM_VOLATILE_P (op)))) && ((
#line 345 "../../gcc/config/rs6000/predicates.md"
(reload_completed)) ? (memory_operand (op, mode)) : ((
#line 347 "../../gcc/config/rs6000/predicates.md"
(reload_in_progress)) ? (
#line 348 "../../gcc/config/rs6000/predicates.md"
(strict_memory_address_p (mode, XEXP (op, 0)))) : (
#line 349 "../../gcc/config/rs6000/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 354 "../../gcc/config/rs6000/predicates.md"
...
#line 361 "../../gcc/config/rs6000/predicates.md"
...
#line 369 "../../gcc/config/rs6000/predicates.md"
{
  op = XEXP (op, 0);
  if (TARGET_ALTIVEC
...
{
  return (
#line 383 "../../gcc/config/rs6000/predicates.md"
(REG_P (op)
		    || (GET_CODE (op) == PLUS
...
{
  return (
#line 394 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) ? (
#line 402 "../../gcc/config/rs6000/predicates.md"
(satisfies_constraint_I (op)
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 409 "../../gcc/config/rs6000/predicates.md"
(!satisfies_constraint_I (op)
...
#line 416 "../../gcc/config/rs6000/predicates.md"
{
...
#line 462 "../../gcc/config/rs6000/predicates.md"
{
  HOST_WIDE_INT c, lsb;
...
#line 507 "../../gcc/config/rs6000/predicates.md"
{
  HOST_WIDE_INT c, lsb;
...
#line 532 "../../gcc/config/rs6000/predicates.md"
{
  HOST_WIDE_INT c, lsb;
...
#line 558 "../../gcc/config/rs6000/predicates.md"
{
  HOST_WIDE_INT c, lsb;
...
#line 601 "../../gcc/config/rs6000/predicates.md"
...
#line 609 "../../gcc/config/rs6000/predicates.md"
(TARGET_POWERPC64 && mode == DImode)) && (mask64_operand (op, mode))) || ((
#line 611 "../../gcc/config/rs6000/predicates.md"
(fixed_regs[CR0_REGNO])) ? (gpc_reg_operand (op, mode)) : (logical_operand (op, mode))));
}
...
#line 624 "../../gcc/config/rs6000/predicates.md"
...
{
  return (GET_CODE (op) == MEM) ? (((
#line 631 "../../gcc/config/rs6000/predicates.md"
(!TARGET_E500_DOUBLE)) && ((memory_operand (op, mode)) || ((
#line 633 "../../gcc/config/rs6000/predicates.md"
...
#line 647 "../../gcc/config/rs6000/predicates.md"
{
  rtx inner = op;
...
#line 670 "../../gcc/config/rs6000/predicates.md"
((mode == VOIDmode || GET_MODE (op) == mode)
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 686 "../../gcc/config/rs6000/predicates.md"
...
{
  return ((GET_CODE (op) == REG) ? (
#line 692 "../../gcc/config/rs6000/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 706 "../../gcc/config/rs6000/predicates.md"
((DEFAULT_ABI != ABI_AIX || SYMBOL_REF_FUNCTION_P (op))
...
#line 717 "../../gcc/config/rs6000/predicates.md"
{
...
#line 778 "../../gcc/config/rs6000/predicates.md"
{
  if ((TARGET_E500_DOUBLE || TARGET_SPE)
      && GET_CODE (op) == SUBREG
      && invalid_e500_subreg (op, mode))
...
#line 808 "../../gcc/config/rs6000/predicates.md"
(GET_MODE_CLASS (GET_MODE (XEXP (op, 0))) == MODE_CC)) && (
#line 809 "../../gcc/config/rs6000/predicates.md"
...
#line 833 "../../gcc/config/rs6000/predicates.md"
{
...
#line 873 "../../gcc/config/rs6000/predicates.md"
{
...
#line 913 "../../gcc/config/rs6000/predicates.md"
{
  int index;
  int i;
  rtx elt;
...
#line 979 "../../gcc/config/rs6000/predicates.md"
{
  int index;
  int i;
  rtx elt;
...
#line 1048 "../../gcc/config/rs6000/predicates.md"
{
  int count = XVECLEN (op, 0);
...
#line 1081 "../../gcc/config/rs6000/predicates.md"
{
  int count = XVECLEN (op, 0);
  int i;
...
#line 1128 "../../gcc/config/rs6000/predicates.md"
{
  int count = XVECLEN (op, 0);
  int i;
  rtx src_reg;
...
#line 1174 "../../gcc/config/rs6000/predicates.md"
{
  int count = XVECLEN (op, 0);
  unsigned int dest_regno;
  rtx src_addr;
...
#line 1249 "../../gcc/config/rs6000/predicates.md"
{
  int count = XVECLEN (op, 0);
  unsigned int src_regno;
  rtx dest_addr;
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 59 "../../gcc/config/rs6000/constraints.md"
((unsigned HOST_WIDE_INT) (ival + 0x8000) < 0x10000);

    case CONSTRAINT_J:
      return 
#line 64 "../../gcc/config/rs6000/constraints.md"
((ival & (~ (unsigned HOST_WIDE_INT) 0xffff0000)) == 0);

    case CONSTRAINT_K:
      return 
#line 69 "../../gcc/config/rs6000/constraints.md"
((ival & (~ (HOST_WIDE_INT) 0xffff)) == 0);

    case CONSTRAINT_L:
      return 
#line 74 "../../gcc/config/rs6000/constraints.md"
(((ival & 0xffff) == 0
		      && (ival >> 31 == -1 || ival >> 31 == 0)));

    case CONSTRAINT_M:
      return 
#line 80 "../../gcc/config/rs6000/constraints.md"
(ival > 31);

    case CONSTRAINT_N:
      return 
#line 85 "../../gcc/config/rs6000/constraints.md"
(ival > 0 && exact_log2 (ival) >= 0);

    case CONSTRAINT_O:
      return 
#line 90 "../../gcc/config/rs6000/constraints.md"
(ival == 0);

    case CONSTRAINT_P:
      return 
#line 95 "../../gcc/config/rs6000/constraints.md"
((unsigned HOST_WIDE_INT) ((- ival) + 0x8000) < 0x10000);
